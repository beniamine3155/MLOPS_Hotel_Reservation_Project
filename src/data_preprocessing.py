...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            logger.info("Start our data processing step")
            ...
            logger.error(f"Error occur while during preprocess step {e}")
...
if __name__ == "__main__":
    processor = DataProcessor(TRAIN_FILE_PATH, TEST_FILE_PATH, PROCESSED_DIR, CONGIG_PATH)
    processor.process()
